...
import { X, User, Phone, Mail, Building, Hash, Loader2 } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import { apiClient } from "@/lib/api";

interface AddCustomerSlideOverProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;
}

export default function AddCustomerSlideOver({
  isOpen,
  onClose,
  onSuccess,
}: AddCustomerSlideOverProps) {
                    ...
                    <div className="flex min-h-0 flex-1 flex-col overflow-y-scroll py-6">
                      ...
                      <div className="px-6">
                        ...
                        <p className="mt-1 text-sm text-gray-500 leading-snug">
                          Enter details to create a new customer record directly.
                        </p>
                      </div>
